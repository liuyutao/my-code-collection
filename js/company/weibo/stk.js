...
STK.register("core.ani.transition", function (a) {
    ...
    return function (d, e) {
        var f = a.core.obj.parseParam({target: "", duration: 500, timingFn: [0, 0, 1, 1], callback: function () {
        }}, e), g = "all " + f.duration + "ms cubic-bezier(" + f.timingFn.join(",") + ")", h = a.core.dom.cssText(d.style.cssText), i = "test", j = b();
        h.merge(f.target);
        h.push("transition", g);
...
STK.register("core.dom.sizzle", function (a) {
    ...
    var g = function (a, c, e, f) {
        ...
        if (k.length > 1 && i.exec(a))if (k.length === 2 && h.relative[k[0]])n = q(k[0] + k[1], c); else {
        ...
        o || (o = n);
        o || g.error(v || a);
        if (d.call(o) === "[object Array]")if (!r)e.push.apply(e, o); else if (c && c.nodeType === 1)for (x = 0; o[x] != null; x++)o[x] && (o[x] === !0 || o[x].nodeType === 1 && g.contains(c, o[x])) && e.push(n[x]); else for (x = 0; o[x] != null; x++)o[x] && o[x].nodeType === 1 && e.push(n[x]); else l(o, e);
        if (p) {
            g(p, j, e, f);
            g.uniqueSort(e)
        }
    ...
    g.filter = function (a, b, c, d) {
        ...
        while (a && b.length) {
            for (var m in h.filter)if ((j = h.leftMatch[m].exec(a)) != null && j[2]) {
                ...
                if (h.preFilter[m]) {
                    ...
                    if (!j)k = o = !0; else if (j === !0)continue
                }
                if (j)for (var r = 0; (p = i[r]) != null; r++)if (p) {
                    o = n(p, j, r, i);
                    var s = d ^ !!o;
                    if (c && o != null)s ? k = !0 : i[r] = !1; else if (s) {
                        f.push(p);
                        k = !0
                    }
                }
            ...
            if (a === e)if (k == null)g.error(a); else break;
            e = a
        }
        return i
    };
    ...
    var h = {order: ["ID", "NAME", "TAG"], match: {ID: /#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, CLASS: /\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/, ATTR: /\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/, TAG: /^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/, CHILD: /:(only|nth|last|first)-child(?:\((even|odd|[\dn+\-]*)\))?/, POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/, PSEUDO: /:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch: {}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {href: function (a) {
        ...
        d && (b = b.toLowerCase());
        for (var f = 0, h = a.length, i; f < h; f++)if (i = a[f]) {
        ...
        if (a[1] === "not")if ((b.exec(a[3]) || "").length > 1 || /^\w/.test(a[3]))a[3] = g(a[3], null, null, c); else {
            var i = g.filter(a[3], c, d, !0 ^ f);
            d || e.push.apply(e, i);
            return!1
        } else if (h.match.POS.test(a[0]) || h.match.CHILD.test(a[0]))return!0;
        return a
    }, POS: function (a) {
        a.unshift(!0);
        return a
        ...
        if (e === "contains")return(a.textContent || a.innerText || g.getText([a]) || "").indexOf(b[3]) >= 0;
        if (e === "not") {
            var i = b[3];
    ...
    try {
        ...
        l = function (a, b) {
            var c = b || [], e = 0;
            if (d.call(a) === "[object Array]")Array.prototype.push.apply(c, a); else if (typeof a.length == "number")for (var f = a.length; e < f; e++)c.push(a[e]); else for (; a[e]; e++)c.push(a[e]);
            return c
        }
    }
    var n;
    ...
    g.getText = function (a) {
        ...
        for (var d = 0; a[d]; d++) {
            c = a[d];
            c.nodeType === 3 || c.nodeType === 4 ? b += c.nodeValue : c.nodeType !== 8 && (b += g.getText(c.childNodes))
        }
        return b
    };
    (function () {
    ...
    (function () {
        ...
        a.firstChild && typeof a.firstChild.getAttribute != "undefined" && a.firstChild.getAttribute("href") !== "#" && (h.attrHandle.href = function (a) {
    ...
    document.querySelectorAll && function () {
        ...
        if (!b.querySelectorAll || b.querySelectorAll(".TEST").length !== 0) {
            g = function (b, c, d, e) {
                c = c || document;
                if (!e && c.nodeType === 9 && !g.isXML(c))try {
    ...
    var q = function (a, b) {
        ...
        a = h.relative[a] ? a + "*" : a;
        for (var i = 0, j = f.length; i < j; i++)g(a, f[i], c);
        return g.filter(d, c)
    };
    return g
});
STK.register("core.dom.builder", function (a) {
    return function (b, c) {
        ...
        var f, g;
        f = {};
        if (c)for (j in selectorList)f[j] = a.core.dom.sizzle(c[j].toString(), e); else {
...
STK.register("core.dom.ready", function (a) {
    var b = [], c = !1, d = a.core.func.getType, e = a.core.util.browser, f = a.core.evt.addEvent, g = function () {
        if (!c && document.readyState === "complete")return!0;
        return c
    }, h = function () {
        if (c != !0) {
            c = !0;
...
STK.register("core.dom.neighbor", function (a) {
    ...
    var b = function (b, c, d) {
        return b && a.core.dom.dir(b, {dir: c, expr: d})[0]
    }, d = function (d) {
        var e = d, f = {getCurrent: function () {
            return e
            ...
            var d = b ? a.core.dom.sizzle(b, e)[0] : a.core.dom.firstChild(e);
            d ? e = d : c("child", b);
            return f
        }, firstChild: function () {
            var b = a.core.dom.firstChild(e);
            b ? e = b : c("firstChild");
            return f
        }, lastChild: function () {
            var b = a.core.dom.lastChild(e);
            b ? e = b : c("lastChild");
            return f
        }, prev: function (a) {
            var d = b(e, "prev", a);
...
STK.register("core.json.jsonToStr", function (a) {
    function j(a, b) {
        ...
        switch (typeof n) {
            ...
            case"object":
                ...
                } else for (d in n)if (Object.hasOwnProperty.call(n, d)) {
                    g = j(d, n);
                    g && m.push(i(d) + (e ? ": " : ":") + g)
                }
                g = m.length === 0 ? "{}" : e ? "{\n" + e + m.join(",\n" + e) + "\n" + l + "}" : "{" + m.join(",") + "}";
    ...
    var c = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, d = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, e, f, g = {"\b": "\\b", "\t": "\\t", "\n": "\\n", "\f": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\"}, h;
    return function (a, b, c) {
        if (window.JSON && window.JSON.stringify)return window.JSON.stringify(a, b, c);
        var d;
        e = "";
        f = "";
        if (typeof c == "number")for (d = 0; d < c; d += 1)f += " "; else typeof c == "string" && (f = c);
        h = b;
        if (!b || typeof b == "function" || typeof b == "object" && typeof b.length == "number")return j("", {"": a});
...
STK.register("core.str.queryString", function (a) {
    return function (b, c) {
        var d = a.core.obj.parseParam({source: window.location.search.substr(1), split: "&"}, c), e = (new RegExp("(^|" + d.split + ")" + b + "=([^\\" + d.split + "]*)(\\" + d.split + "|$)", "gi")).exec(d.source), f;
        return(f = e) ? f[2] : null
    }
});
