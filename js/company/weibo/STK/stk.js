...
(function (window, document, undefined) {
    var cEvt = function () {
        var a = function (a) {
        ...
        }, c = "__custEventKey__", d = 1, e = {}, f = function (a, b) {
            var d = typeof a == "number" ? a : a[c];
            return d && e[d] && {obj: typeof b == "string" ? e[d][b] : e[d], key: d}
        }, g = {}, h = function (a, b, c, d, e) {
            if (a && typeof b == "string" && c) {
                var g = f(a, b);
                if (!g || !g.obj)throw"custEvent (" + b + ") is undefined !";
                g.obj.push({fn: c, data: d, once: e});
                return g.key
            }
        }, i = function (a, c, d, e) {
            var g = !0, h = function () {
            ...
            if (a && typeof c == "string") {
                ...
                if (i && (j = i.obj)) {
                    ...
                    for (var k = j.length - 1; k > -1 && j[k]; k--) {
                        ...
                        if (l && l.apply)try {
                            l.apply(a, [
                                {obj: a, type: c, data: j[k].data, preventDefault: h}
                            ].concat(d));
                            m && j.splice(k, 1)
                        } catch (n) {
                            window.console && console.log("[error][custEvent]" + n.message, n, n.stack)
                        }
                    }
                    g && b(e) === "function" && e();
                    return i.key
        ...
        }, j = {define: function (a, b) {
            if (a && b) {
                var f = typeof a == "number" ? a : a[c] || (a[c] = d++), g = e[f] || (e[f] = {});
                b = [].concat(b);
                for (var h = 0; h < b.length; h++)g[b[h]] || (g[b[h]] = []);
                return f
            }
        }, undefine: function (a, b) {
            if (a) {
                var d = typeof a == "number" ? a : a[c];
                if (d && e[d])if (b) {
                    b = [].concat(b);
                    for (var f = 0; f < b.length; f++)b[f]in e[d] && delete e[d][b[f]]
                } else delete e[d]
            }
            ...
            if (!(!a || !b || !f)) {
                var h = [], k = a[c], l = k && e[k], m, n = b[c] || (b[c] = d++), o;
                if (l) {
                    o = g[k + "_" + n] || (g[k + "_" + n] = {});
                    var p = function (a) {
                        var c = !0;
                        i(b, o[a.type].type, Array.prototype.slice.apply(arguments, [1, arguments.length]), function () {
                            c = !1
                        });
                        c && a.preventDefault()
                    };
        ...
        }, unhook: function (a, b, d) {
            if (!(!a || !b || !d)) {
                var e = a[c], f = b[c], h = g[e + "_" + f];
                if (h)for (var i in d) {
                    var k = d[i];
                    h[i] && j.remove(a, i, h[i].fn)
                }
            }
        }, destroy: function () {
            e = {};
        ...
        return j
    }(), utils = {count: 0, getUniqueKey: function () {
        return+(new Date) + (Math.random() + "").replace(".", "") + utils.count++
    }, json2str: function () {
        function i(a, b) {
            var c, f, j, k, l = d, m, n = b[a];
        ...
        return function (a, b, c) {
            if (window.JSON && window.JSON.stringify)return window.JSON.stringify(a, b, c);
            var f;
            d = "";
            e = "";
            if (typeof c == "number")for (f = 0; f < c; f += 1)e += " "; else typeof c == "string" && (e = c);
            g = b;
            if (!b || typeof b == "function" || typeof b == "object" && typeof b.length == "number")return i("", {"": a});
        ...
        return c != null ? unescape(c[2]) : null
    }}, iframeConnect = function () {
        var a = {}, b = {}, c = window.name, d = function (a, b, d) {
            var e = utils.json2str(d === undefined ? {iid: c, cid: a, cmd: b} : {iid: c, cid: a, cmd: b, param: d});
            window.parent.postMessage ? window.parent.postMessage(e, "*") : window.navigator.STK_IFRAME_CONNECT_OUT(e)
        }, e = function (c) {
        ...
        window.postMessage ? window.addEventListener ? window.addEventListener("message", e, !1) : window.attachEvent("onmessage", e) : window.navigator["STK_IFRAME_CONNECT_" + c] = function (a) {
            e({data: a})
        };
        return{trigger: function (b, c, e) {
            if ((typeof c).toUpperCase() === "FUNCTION") {
                e = c;
                c = undefined
            }
            var f = utils.getUniqueKey();
            e && (a[f] = e);
            d(f, b, c)
        }, on: function (a, c) {
            cEvt.define(b, a);
    ...
    window.iconnect = iframeConnect();
    window.iframeConnect = function () {
        return window.iconnect
    };
    window.iconnect.setHeight = function (a, b) {
        window.iconnect.trigger("setHeight", a, b)
    };
    window.iconnect.getLayoutInfo = function (a) {
        window.iconnect.trigger("getLayoutInfo", a)
    }
})(window, document);
(function () {
    var STK = arguments[0];
    ...
    var a = STK;
    STK.register("third.dataTransferV2", function (a) {
        window.name = "";
        return function (b) {
            var c = {}, d, e, f = 0, g = a.core.json.queryToJson, h = a.core.json.jsonToQuery, i = a.core.json.merge, j = b.clientId, k = function (a) {
                window.setTimeout(function () {
                    alert(a)
                }, 3e3)
            };
            a.custEvent.define(c, "message");
            var l = function (b) {
                b = b || window.event;
                var d = unescape(b.data), e = g(d);
                for (var f in e) {
                    isNaN(e[f]) || (e[f] = e[f] == "" ? 0 : parseInt(e[f]));
                    if (e[f] == "true" || e[f] == "false")e[f] = e[f] == "true"
                }
                a.custEvent.fire(c, "message", e)
            }, m = [], n = !1, o = function (a) {
                if (m.length > 0) {
                    var b = m.shift(0);
                    a.name = b
            ...
            c.sendMessage = function (a, b, c) {
                b && (a.inner = b);
                a.jump && (a.jump = encodeURIComponent(decodeURIComponent(a.jump)));
                var d = a.scroll, e = h(a);
                e = escape(e);
                var g = c ? c.contentWindow : window.parent;
                if (window.postMessage)g.postMessage(e, "*"); else {
                    var i = (new Date).getTime() + f++ + "^" + document.domain + "&" + window.escape(e);
                    d ? m = [i] : m.push(i);
                    n || o(g);
                    n = !0
                }
            ...
            var p = function (a, b) {
                ...
                function f(a) {
                    var b;
                    b = a.split("^").pop().split("&");
                    var c = {domain: b[0], data: window.unescape(b[1])};
                    return c
                }
                ...
                window.postMessage ? a.addEvent(window, "message", l) : p(window, "name")
            }, r = function () {
                e = i({}, b)
            }, s = {}, t = function (a, b) {
                s[a] || (s[a] = []);
                ...
                if (!a)for (var c in s)s[c] = []; else if (!b)s[a] = []; else {
                    b = [].concat(b);
            ...
            c.undefine = function (a) {
                v(a)
            };
            c.fireEvent = function (a, b, d, e) {
                var f = s[a];
                if (!!f) {
                    var g = b || {};
                    if (f.length == 1 && f[0].reg) {
                        g.type = a;
                        g.reg = !0;
                        g.uniqueId = d;
                        c.sendMessage(g, !0, e);
            ...
            var w = function () {
                clearInterval(d);
                d = null;
                a.custEvent.undefine(c, "message");
                a.removeEvent(window, "message")
            }, x = function () {
                r();
                q()
            };
    ...
    STK.register("third.clientV2", function (a) {
        return function (b) {
            var c = {}, d, e, f, g, h, i = a.core.json.merge, j = a.core.json.jsonToQuery, k = !0, l = 0, m = a.core.util.getUniqueKey(), n = encodeURIComponent(window.location.href);
            a.custEvent.define(c, ["message", "scroll"]);
            var o = function (a) {
            }, p = function () {
                b || (b = {});
                e = i({scroll: !0}, b)
            }, q, r = function () {
                var b = a.core.util.pageSize().page, c = b.width, d = b.height, e;
                if (q) {
                    var i = document.body.childNodes;
                    i[i.length - 1] !== q && document.body.appendChild(q);
                    var j = q.getBoundingClientRect();
                    e = j.top + 10;
                    if (e !== parseInt(q.getAttribute("_top"))) {
                        d = e;
                        q.setAttribute("_top", d)
                    }
                }
                if (c != g || d != h) {
                    g = c;
                    ...
                    if (!q) {
                        ...
                        e = q.getBoundingClientRect().top + 10;
                        q.setAttribute("_top", e);
                        if (a.core.util.browser.IE && h == e) {
                            f.sendMessage({height: e}, !0);
                            return
                        }
                        h = e
                    }
            ...
            c.unLogin = function () {
                f.sendMessage({unLogin: !0, pageUrl: n}, !0);
                return c
            };
            var s = function (a, b) {
                if (b.initBack && b.uniqueId && b.clientId == m) {
                    k = !1;
                    f.sendMessage({initAll: !0, pageUrl: n, uniqueId: l, clientId: m}, !0);
                    l = b.uniqueId;
                    setTimeout(v, 500)
                }
                if (!!b.init || !l || l === b.uniqueId) {
                    if (!b.inner)f.fireEvent("message", b); else if (b.reg) {
                        var c = b.type;
                        delete b.type;
                        f.fireEvent(c, b)
                    }
                    if (b.scroll) {
                        delete b.inner;
                        delete b.scroll;
                        f.fireEvent("scroll", b)
                    }
                    if (b.init) {
                        clearInterval(d);
                        d = null;
                        f.sendMessage({init: !0, pageUrl: n, uniqueId: l, clientId: m}, !0);
                        setTimeout(v, 500)
                    }
                }
            }, t = function () {
                f = a.third.dataTransferV2({type: "client", clientId: m});
                ...
                a.custEvent.add(f, "message", s)
            };
            c.parentReload = function () {
                f.sendMessage({reload: !0}, !0)
            };
            var v = function () {
                clearInterval(d);
                d = setInterval(r, 500)
                ...
                t();
                u();
                if (a.core.util.browser.IE)setTimeout(function () {
                    f.sendMessage({init: !0, pageUrl: n, uniqueId: l, clientId: m}, !0);
                    v()
                }, 200); else {
                    f.sendMessage({init: !0, pageUrl: n, uniqueId: l, clientId: m}, !0);
                ...
                clearInterval(d);
                d = null;
                a.custEvent.remove(f, "message");
                f.destroy();
                a.custEvent.undefine(c, ["message", "scroll"]);
                c.sendMessage = a.core.func.empty
            };
            window.parent !== window.self && w();
            c.destroy = x;
            return c
        }
    });
    var b = a.third.clientV2();
    b.define("taobao_bind_check_callback");
    window.bindComplete = function (a) {
        b.fireEvent("taobao_bind_check_callback", a);
        window.iconnect && window.iconnect.trigger("taobao_bind_check_callback", a)
    }
})();
