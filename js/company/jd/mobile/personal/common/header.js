		...
		MCommonHeaderBottom = function(d) {
			...
			var b = {
				...
				_getLinksHtml: function(i) {
					var k = "";
					if (i.pin && i.pin != "") {
						k = '        <li class=""><a class="J_ping" report-eventid="MCommonHTail_Account"  report-eventparam="" page_name="' + f + '" rel="nofollow"  href="http://home.m.jd.com/myJd/home.action{sid}">{pin}</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_Exit"  report-eventparam="" page_name="' + f + '" rel="nofollow" href="https://passport.m.jd.com/user/logout.action{sid}">退出</a></li>'
					} else {
						k = '        <li class=""><a class="J_ping" report-eventid="MCommonHTail_Login"  report-eventparam="" page_name="' + f + '" rel="nofollow" href="https://passport.m.jd.com/user/login.action{sid}">登录</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_Register"  report-eventparam="" page_name="' + f + '" rel="nofollow"  href="http://passport.m.jd.com/register/mobileRegister.action{sid}">注册</a></li>'
					}
					var m = '	<div class="jd-1px-line-up"></div>    <ul class="jd-footer-links">' + k + '        <li><a class="J_ping" report-eventid="MCommonHTail_Feedback"  report-eventparam="" page_name="' + f + '" rel="nofollow" href="http://m.jd.com/showvote.html{sid}">反馈</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_ToTop"  report-eventparam="" page_name="' + f + '" rel="nofollow" href="#top">回到顶部</a></li>    </ul>';
					...
					for (var l = 0; l < q.length; l++) {
						...
						if (m.name == "standard") {
							...
							if (m.name == "touchscreen") {
								p += '<li id="{prefix}_touchscreen" class="jd-footer-icon-touchscreen current"><a ' + k + ' class="J_ping" report-eventid="MCommonHTail_TouchEdition"  report-eventparam="" page_name="' + f + '">触屏版</a></li>'
							} else {
								if (m.name == "pc") {
									p += '<li id="{prefix}_pc" class="jd-footer-icon-pc"><a ' + k + ' class="J_ping" report-eventid="MCommonHTail_PCEdition"  report-eventparam="" page_name="' + f + '">电脑版</a></li>'
								} else {
									if (m.name == "apps") {
										p += '<li id="{prefix}_apps"  class="jd-footer-icon-apps"><a class="badge" "' + k + ' class="J_ping" report-eventid="MCommonHTail_ClientApp"  report-eventparam="" page_name="' + f + '">客户端</a></li>'
									}
								}
							}
						}
				...
				_getCopyrightHtml: function(i) {
					var j = '<div class="jd-1px-line-up"></div><div class="jd-footer-copyright">Copyright ? 2012-2015 京东JD.com 版权所有 </div>';
					return j
				},
			...
			var g = {
				...
				_isHasTipId: function() {
					...
					if (c.getElementById(this.args.tipId)) {
						...
						c.printDeugInfo("请正确拼写或添加通用提示ID.")
					}
					return i
				}
			};
